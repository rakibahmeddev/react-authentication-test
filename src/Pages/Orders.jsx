...
const Orders = () => {
  return (
    <div>
      {/* Table Section */}
      <div className=" max-w-[100%] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h2 className="text-center text-4xl font-semibold mb-10">Orders</h2>
        {/* Card */}
                    ...
                    <tr className="bg-white hover:bg-gray-50">
                      ...
                      <td className="h-px w-72 min-w-72 align-top">
                        <a className="block p-6" href="#">
                          ...
                          <span className="block text-sm text-gray-500">
                            A really well built shoe. It looks great and wears
                            just as well. A great staple in ball caps.
                          </span>
                        </a>
                      </td>
                      <td className="size-px whitespace-nowrap align-top">
                    ...
                    <tr className="bg-white hover:bg-gray-50">
                      ...
                      <td className="h-px w-72 min-w-72 align-top">
                        <a className="block p-6" href="#">
                          ...
                          <span className="block text-sm text-gray-500">
                            Don't let this merchandise get away! It's a must buy
                            and you will look good in it while working out.
                          </span>
                        </a>
                      </td>
                      <td className="size-px whitespace-nowrap align-top">
                    ...
                    <tr className="bg-white hover:bg-gray-50">
                      ...
                      <td className="h-px w-72 min-w-72 align-top">
                        <a className="block p-6" href="#">
                          ...
                          <span className="block text-sm text-gray-500">
                            As good as the heat Rdy T-shirt but without the
                            sleeves. Love the stripes on the back.
                          </span>
                        </a>
                      </td>
                      <td className="size-px whitespace-nowrap align-top">
