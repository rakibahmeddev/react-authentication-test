  ...
  return (
    <div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h2 className="text-center text-4xl font-semibold mb-10">About Company</h2>
              ...
              >
                ...
                >
                  <span className="flex gap-x-6">
                    <svg
                      className="shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-yellow-400 text-gray-800"
                    ...
                    <span className="grow">
                      <span className="block text-lg font-semibold hs-tab-active:text-yellow-400 text-gray-800">
                        Advanced tools
                      </span>
