    ...
    <div>
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-cyan-800 sm:text-4xl lg:text-6xl lg:leading-tight">
              Start your journey with{' '}
              <span className="text-cyan-600">Nextora</span>
            </h1>
            ...
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <a
                className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-yellow-300 text-black hover:bg-cyan-950 hover:text-white focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none"
                href="#"
              >
                Get started
                <svg
